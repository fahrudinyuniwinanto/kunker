...
insert  into `sy_menu`(`id_menu`,`label`,`redirect`,`url`,`parent`,`icon`,`note`,`order_no`,`created_by`,`created_at`,`updated_by`,`updated_at`) values (20,'Anggota Dewan',0,'Users',19,'fa-user','1',1,'','0000-00-00 00:00:00','','0000-00-00 00:00:00');
insert  into `sy_menu`(`id_menu`,`label`,`redirect`,`url`,`parent`,`icon`,`note`,`order_no`,`created_by`,`created_at`,`updated_by`,`updated_at`) values (21,'Tenaga Ahli',0,'Users',19,'fa-users','1',2,'','0000-00-00 00:00:00','','0000-00-00 00:00:00');
...
insert  into `user_access`(`id`,`id_group`,`kd_access`,`nm_access`,`is_allow`,`note`,`id_menu`) values (1,3,'40',NULL,1,NULL,6);
insert  into `user_access`(`id`,`id_group`,`kd_access`,`nm_access`,`is_allow`,`note`,`id_menu`) values (2,3,'30',NULL,1,NULL,14);
insert  into `user_access`(`id`,`id_group`,`kd_access`,`nm_access`,`is_allow`,`note`,`id_menu`) values (3,3,'23',NULL,1,NULL,18);
...
insert  into `users`(`id_user`,`no_anggota`,`fullname`,`username`,`password`,`email`,`id_group`,`foto`,`telp`,`note`,`created_by`,`updated_by`,`created_at`,`updated_at`,`note_1`,`id_fraksi`,`id_parent`) values (11,NULL,'Dewan 1','dewan1','e2aca4735b9e005136c3946e46e915b9','dewan@gmail.com',3,NULL,NULL,'',6,NULL,'2023-06-10 18:40:37',NULL,NULL,1,0);
insert  into `users`(`id_user`,`no_anggota`,`fullname`,`username`,`password`,`email`,`id_group`,`foto`,`telp`,`note`,`created_by`,`updated_by`,`created_at`,`updated_at`,`note_1`,`id_fraksi`,`id_parent`) values (12,NULL,'TA Dewan1','tadewan1','ccf93997f9e7f9ec0208104a2f29a8ab','masruriakhmad@gmail.com',3,NULL,NULL,'ads',6,NULL,'2023-06-10 20:34:07',NULL,NULL,0,11);
insert  into `users`(`id_user`,`no_anggota`,`fullname`,`username`,`password`,`email`,`id_group`,`foto`,`telp`,`note`,`created_by`,`updated_by`,`created_at`,`updated_at`,`note_1`,`id_fraksi`,`id_parent`) values (13,NULL,'TA Dewan11','tadewan1','ccf93997f9e7f9ec0208104a2f29a8ab','masruriakhmad@gmail.com',3,NULL,NULL,'ads',6,NULL,'2023-06-10 20:34:07',NULL,NULL,0,11);
