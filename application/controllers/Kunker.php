...
class Kunker extends CI_Controller
{
	...
	$this->form_validation->set_rules('id_kunker_ta', 'id kunker ta', 'trim|required');
	...
	$this->form_validation->set_rules('file_nodin', 'file nodin', 'trim|required');
	$this->form_validation->set_rules('pemberi_disposisi', 'pemberi disposisi', 'trim|required');
	...
	$this->form_validation->set_rules('status_disposisi', 'status disposisi', 'trim|required');
	$this->form_validation->set_rules('created_at', 'created at', 'trim|required');
	$this->form_validation->set_rules('disposisi_at', 'disposisi at', 'trim|required');
	$this->form_validation->set_rules('created_by', 'created by', 'trim|required');
	$this->form_validation->set_rules('disposisi_by', 'disposisi by', 'trim|required');
	$this->form_validation->set_rules('diposisi_note', 'diposisi note', 'trim|required');
...
/* End of file Kunker.php */
/* Location: ./application/controllers/Kunker.php */
