...
<h1 class="page-header">Jenis_kunjungan  <small></small></h1>
...
<?php if ($this->session->userdata('message') != '') { ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 class="panel-title" style="margin-top:0px"><?php echo $button ?> Jenis_kunjungan </h2>
	    ...
	    <div class="mb-3">
            <label class="form-label" for="varchar">Nama Kunker <?php echo form_error('nama_kunker') ?></label>
            <input type="text" class="form-control" name="nama_kunker" id="nama_kunker" placeholder="Nama Kunker" value="<?php echo $nama_kunker; ?>" />
        </div>
	    <div class="mb-3">
            <label class="form-label" for="int">Maksimal Kunjungan <?php echo form_error('maksimal_kunjungan') ?></label>
            <input type="text" class="form-control" name="maksimal_kunjungan" id="maksimal_kunjungan" placeholder="Maksimal Kunjungan" value="<?php echo $maksimal_kunjungan; ?>" />
        </div>
	    <div class="mb-3">
