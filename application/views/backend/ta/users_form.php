        ...
        <div class="panel panel-default">
            ...
            <form action="<?php echo $action; ?>" method="post">
                <div class="panel-body">
                    ...
                    <div class="mb-3">
                        <label for="int" class="form-label">Nama Anggota Dewan<?php echo form_error('id_anggota_fraksi') ?></label>
                        <?= form_dropdown('id_anggota_fraksi', get_combo_where('users', 'id_user', 'fullname', ['' => "--Pilih--"], ['id_parent' => '0']), $id_anggota_fraksi, ['class' => 'form-control']) ?>
                    </div>
