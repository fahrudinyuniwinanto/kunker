...
<div class="row">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2 class="panel-title" style="margin-top:0px">Kunker_ta Read</h2>
        ...
        <table class="table">
	    <tr><td>Id Kunker</td><td><?php echo $id_kunker; ?></td></tr>
	    <tr><td>Id Ta</td><td><?php echo $id_ta; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('kunker_ta') ?>" class="btn btn-flat btn-default">Cancel</a></td></tr>
	</table>
             </div>
            </div>
        </div>
