...
<h1 class="page-header">Data Anggota Fraksi <small></small></h1>
            ...
            <div class="panel-body">
                <div class="row" style="margin-bottom: 10px">
                    ...
                    <div class="col-md-3 text-right">
                        <?php
                        if (allow([1])) { ?>
                            <form action="<?php echo site_url('anggota_fraksi/index'); ?>" class="form-inline" method="get">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center" width="200px">
                                    <?php
                                        ...
                                        echo ' | ';
                                        echo anchor(site_url('anggota_fraksi/update/' . $users->id_user), '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"');
                                        echo ' | ';
                                        echo anchor(site_url('anggota_fraksi/delete/' . $users->id_user), '<i class="fa fa-trash"></i>', 'class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="javascript: return confirm(\'Yakin hapus data?\')"');
