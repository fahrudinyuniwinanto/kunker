...
<head>
    ...
    <link href="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/jvectormap-next/jquery-jvectormap.css"
        rel="stylesheet" />
    <link
        href="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.css"
        rel="stylesheet" />
    <link href="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/gritter/css/jquery.gritter.css"
        rel="stylesheet" />
...
<body>
    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed app-content-full-height">
        ...
        <div id="header" class="app-header">
            ...
            <div class="navbar-header">
                <a href="<?= site_url('Backend') ?>" class="navbar-brand"><img alt="image"
                        src="<?= base_url() ?>assets/img/dpr.png" style="width: 32px;" />&nbsp;<b>
                        <?= data_app('APP_NAME') ?>
                    </b></a>
            ...
            <div class="navbar-nav">
                <div class="navbar-item dropdown">
                    <a href="#" data-bs-toggle="dropdown" class="navbar-link dropdown-toggle icon">
                        ...
                        <span class="badge numrows-notif">
                            0
                        </span>
                    </a>
                            ...
                            <a href="<?= base_url() ?>kunker/verify/<?= $v->id_kunker ?>" class="dropdown-item media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="text-muted fs-10px">Pada
                                        <?= tanggal_indo(date_format(date_create($v->disposisi_at), 'Y-m-d')) ?><br>
                                        <?= $this->db->get_where('jenis_kunjungan', ['id_jenis_kunjungan' => $v->id_jenis_kunjungan])->row()->nama_kunker ?>
                                    </div>
                                </div>
                            </a>
                        <?php endforeach ?>
                    ...
                    <a href="#" class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                        <?php if ($this->session->userdata('foto') != '' && file_exists(FCPATH . "assets/foto_users/" . $this->session->userdata('foto'))) { //die('a');
                            ...
                            <img alt="image"
                                ...
                                style="width: 45px;" />
                        <?php } else { ?>
                            <img alt="image" src="<?= base_url() ?>assets/img/user.png" style="width: 32px;" />
                        <?php } ?>
                        <span>
            ...
            <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
                ...
                <div class="menu">
                            ...
                            <div class="menu-profile-image">
                                <?php if ($this->session->userdata('foto') != '' && file_exists(FCPATH . "assets/foto_users/" . $this->session->userdata('foto'))) { //die('a');
                                    ...
                                    <img alt="image" class="img-circle"
                                        ...
                                        style="width: 45px;" />
                                <?php } else { ?>
                                    <img alt="image" class="img-circle" src="<?= base_url() ?>assets/img/user.png"
                                        style="width: 45px;" />
                                <?php } ?>
                            </div>
                    ...
                    <div id="appSidebarProfileMenu" class="collapse">
                        ...
                        <div class="menu-item pt-5px">
                            <a href="<?= base_url() ?>users/ubah_password/<?= getSession('id_user') ?>"
                                class="menu-link">
        ...
        <div class="theme-panel">
            ...
            <div class="theme-panel-content" data-scrollbar="true" data-height="100%">
                ...
                <div class="theme-list">
                    <div class="theme-list-item"><a href="javascript:;" class="theme-list-link bg-red" data-theme="red"
                            data-theme-file="../assets/css/default/theme/red.min.css" data-toggle="theme-selector"
                ...
                <div class="theme-version">
                    <div class="theme-version-item">
                        <a href="../html/index_v2.html" class="theme-version-link active">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme//default.jpg);"
                    ...
                    <div class="theme-version-item">
                        <a href="../transparent/index_v2.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme//transparent.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../apple/index_v2.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme/apple.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../material/index_v2.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme//material.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../facebook/index_v2.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme//facebook.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../google/index_v2.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme//google.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                </div>
                ...
                <div class="theme-version">
                    <div class="theme-version-item">
                        <a href="../html/index.html" class="theme-version-link active">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/html.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../ajax/index.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/ajax.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../angularjs/index.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/angular1x.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../angularjs11/index.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/angular10x.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="javascript:alert('Laravel Version only available in downloaded version.');"
                            ...
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/laravel.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../vuejs/index.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/vuejs.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../reactjs/index.html" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/reactjs.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="javascript:alert('.NET Core 5.0 MVC Version only available in downloaded version.');"
                            class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/version/dotnet.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                </div>
                ...
                <div class="theme-version">
                    <div class="theme-version-item">
                        <a href="../../frontend/one-page-parallax/index.html" target="_blank"
                            class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme/one-page-parallax.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../../frontend/e-commerce/index.html" target="_blank" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme/e-commerce.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../../frontend/blog/index.html" target="_blank" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme/blog.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../../frontend/forum/index.html" target="_blank" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme/forum.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                    <div class="theme-version-item">
                        <a href="../../frontend/corporate/index.html" target="_blank" class="theme-version-link">
                            <span
                                style="background-image: url(<?= base_url() ?>assets/vendor/coloradmin/assets/img/theme/corporate.jpg);"
                                class="theme-version-cover"></span>
                        </a>
                    </div>
                </div>
                ...
                <a href="https://seantheme.com/color-admin/documentation/"
                    class="btn btn-inverse d-block w-100 rounded-pill mb-10px" target="_blank"><b>Documentation</b></a>
    ...
    <audio id="notificationSound" preload="auto">
        <source src="<?= base_url() ?>assets/sounds/sound1.mp3" type="audio/mpeg">
        <!-- Tambahkan sumber audio lain jika diperlukan (misalnya, format ogg) -->
    </audio>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/js/vendor.min.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/js/app.min.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/js/theme/default.min.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/gritter/js/jquery.gritter.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.canvaswrapper.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.colorhelpers.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.saturated.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.browser.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.drawSeries.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.uiConstants.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.time.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.resize.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.pie.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.crosshair.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.categories.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.navigate.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.touchNavigate.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.hover.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.touch.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.selection.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.symbol.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/flot/source/jquery.flot.legend.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/jquery-sparkline/jquery.sparkline.min.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/jvectormap-next/jquery-jvectormap.min.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script
        src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/jvectormap-next/jquery-jvectormap-world-mill.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script
        src="<?= base_url() ?>assets/vendor/coloradmin/assets/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/vendor/coloradmin/assets/js/demo/dashboard.js"
        type="cd38e282cd92834f2cf5392d-text/javascript"></script>
    <script src="<?= base_url() ?>assets/js/jquery-3.6.0.min.js"></script>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="cd38e282cd92834f2cf5392d-|49" defer=""></script>
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js"
        data-cf-beacon='{"rayId":"66b21edf3837370a","version":"2021.6.0","r":1,"token":"4db8c6ef997743fda032d4f73cfeff63","si":10}'></script>
    <script>
        ...
        function getNotifications() {
            $.ajax({
                url: '<?= base_url() ?>kunker/cekNotifikasi', // Ganti dengan URL yang sesuai
                method: 'GET',
                dataType: 'json',
                success: function (response) {
                    // Cek jika ada notifikasi baru
                    if (response.numrows > 0 && !isSoundPlayed) {
                        $(".numrows-notif").html(response.numrows);
                        ...
                        swal({
                            ...
                            type: 'success',
                            imageUrl: 'https://cdn-icons-png.flaticon.com/512/1827/1827295.png', // Ganti dengan path ke gambar Anda
                            imageWidth: 100, // Lebar gambar (sesuaikan)
                            imageHeight: 100, // Tinggi gambar (sesuaikan)
